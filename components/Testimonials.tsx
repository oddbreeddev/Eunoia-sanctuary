...
const Testimonials: React.FC = () => {
  return (
    <section className="py-24 bg-gray-50 dark:bg-black/40 transition-colors duration-300">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((t, i) => (
            <div key={i} className={`p-8 rounded-2xl border ${t.color} backdrop-blur-sm relative`}>
              <Quote className="w-10 h-10 text-gray-300 dark:text-white/10 absolute top-6 right-6" />
              <p className="text-gray-700 dark:text-gray-300 text-lg mb-6 relative z-10">"{t.quote}"</p>
              <div>
